...
GO
CREATE TABLE [Employees is responsible for countries and tours] (
	Id integer NOT NULL,
	Employee_Id integer NOT NULL,
	Country_Id integer NOT NULL,
	TourRoute_Id integer NOT NULL,
...
ALTER TABLE [Tours archive] WITH CHECK ADD CONSTRAINT [Tours archive_fk0] FOREIGN KEY (Tour_Id) REFERENCES Tour(Id)
ON UPDATE CASCADE
GO
ALTER TABLE [Tours archive] CHECK CONSTRAINT [Tours archive_fk0]
GO

ALTER TABLE [Employees is responsible for countries and tours] WITH CHECK ADD CONSTRAINT [Employees is responsible for countries and tours_fk0] FOREIGN KEY (Employee_Id) REFERENCES EmployeeTourAgency(Id)
ON UPDATE CASCADE
GO
ALTER TABLE [Employees is responsible for countries and tours] CHECK CONSTRAINT [Employees is responsible for countries and tours_fk0]
GO
ALTER TABLE [Employees is responsible for countries and tours] WITH CHECK ADD CONSTRAINT [Employees is responsible for countries and tours_fk1] FOREIGN KEY (Country_Id) REFERENCES Country(Id)
ON UPDATE CASCADE
GO
ALTER TABLE [Employees is responsible for countries and tours] CHECK CONSTRAINT [Employees is responsible for countries and tours_fk1]
GO
ALTER TABLE [Employees is responsible for countries and tours] WITH CHECK ADD CONSTRAINT [Employees is responsible for countries and tours_fk2] FOREIGN KEY (TourRoute_Id) REFERENCES TourRoute(Id)
ON UPDATE CASCADE
GO
ALTER TABLE [Employees is responsible for countries and tours] CHECK CONSTRAINT [Employees is responsible for countries and tours_fk2]
GO

ALTER TABLE [Tours clients] WITH CHECK ADD CONSTRAINT [Tours clients_fk0] FOREIGN KEY (Clients_Id) REFERENCES Customers(Id)
ON UPDATE CASCADE
GO
ALTER TABLE [Tours clients] CHECK CONSTRAINT [Tours clients_fk0]
GO
ALTER TABLE [Tours clients] WITH CHECK ADD CONSTRAINT [Tours clients_fk1] FOREIGN KEY (Tour_id) REFERENCES Tour(Id)
ON UPDATE CASCADE
GO
ALTER TABLE [Tours clients] CHECK CONSTRAINT [Tours clients_fk1]
GO
